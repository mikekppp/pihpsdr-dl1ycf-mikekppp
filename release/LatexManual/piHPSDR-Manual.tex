...
settings for controlling if and how peaks are labelled with their dBm values. With the radio buttons
...
for the \texttt{udplistener.c} program there. piHPSDR specifies english (en-GB)
